...
namespace BestLot.UnitTests
{
    ...
    public class LotCommentOperationsHandlerTests
    {
        ...
        public void AddComment_ValidInput_AddsComment()
        {
            ...
            Assert.AreEqual(2, resultUser.LotComments.Count()); Assert.AreEqual("Comment1", resultLot.LotComments[0].Message);
        ...
        public void AddComment_InvalidInput_ThrowsArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(() => lotCommentOperationsHandler.AddComment(invalidUserIdComment));
            Assert.Throws<ArgumentException>(() => lotCommentOperationsHandler.AddComment(invalidLotIdComment));
        }
    }
}
